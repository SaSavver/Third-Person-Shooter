...
public class WeaponSystem : IEcsInitSystem, IEcsRunSystem
{
    ...
    public void Init(IEcsSystems systems)
    {
        ...
        _playerTargetFilter = _world.Filter<PlayerComponent>().Inc<TargetComponent>().End();
    }
    ...
    public void Run(IEcsSystems systems)
    {
        foreach(var playerTarget in _playerTargetFilter)
        {
            ...
            ref var delayComponent = ref _world.GetPool<DelayComponent>().Get(playerTarget);
            ...
            if(Time.time >= delayComponent.NextTime)
            {
                ...
                delayComponent.NextTime = Time.time + weaponComponent.AttackDelay;
            }
